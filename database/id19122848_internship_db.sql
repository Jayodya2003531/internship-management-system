-- phpMycompany SQL Dump
-- version 5.2.1
-- https://www.phpmycompany.net/
--
-- Host: 127.0.0.1
-- Generation Time: Aug 21, 2025 at 03:43 PM
...
ALTER TABLE `intern_position_application`
  ...
  ADD CONSTRAINT `intern_position_application_status` FOREIGN KEY (`status_id`) REFERENCES `application_status_list` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
