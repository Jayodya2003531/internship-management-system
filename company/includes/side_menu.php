...
<div class="sidebar">
    <div class="logo-details">
        <img src="../img/Company_logo_full_cropped.png"></img>
    </div>
    <ul class="nav-links">
        <li>
            <a href="./index.php">
                <i class='bx bx-grid-alt'></i>
                <span class="link_name">Vacanies</span>
            </a>
        </li>
	        <li>
	...
	<li>
            <a href="./interviewShedule.php">
                <i class='bx bx-grid-alt'></i>
                <span class="link_name">Interview Schedule</span>
            </a>
        </li>
        ...
        <li>
            <a href="./settings.php">
                <i class='bx bx-cog'></i>
                <span class="link_name">Setting interviews</span>
            </a>
            <ul class="sub-menu blank">
	...
	<li>
            <a href="./intern_results.php">
                <i class='bx bx-cog'></i>
                <span class="link_name">Interview Results</span>
            </a>
	</li>
	<li>
            <a href="./current_interns.php">
                <i class='bx bx-cog'></i>
                <span class="link_name">Current Interns</span>
            </a>
	</li>
